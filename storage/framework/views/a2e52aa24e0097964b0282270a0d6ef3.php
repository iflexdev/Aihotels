...
<?php     
    ...
    $meta_title = "Listing Page";
    $meta_description = "Listing Page";
    $meta_keyword = "Listing Page";
?>
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="tp-section-title-wrapper mt-50 mb-40 text-center">
                              <h2 class="commonHeading">Find What You Need</h2>
...
<?php echo $__env->make('web.layout.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/nni24/public_html/hotelai360/resources/views/web/hotel-listing.blade.php ENDPATH**/ ?>